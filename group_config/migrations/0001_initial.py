...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('group_config_usergroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['InstituteInfo.InstitueInfo'], null=True, blank=True)),
        ))
        db.send_create_signal('group_config', ['UserGroup'])


    def backwards(self, orm):
        # Deleting model 'UserGroup'
        db.delete_table('group_config_usergroup')
