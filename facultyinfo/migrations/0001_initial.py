...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacultyInfo'
        db.create_table('facultyinfo_facultyinfo', (
            ...
            ('contact_number', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('qualification', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('work_experience', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('rating', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal('facultyinfo', ['FacultyInfo'])

        # Adding model 'FacultyConnections'
        db.create_table('facultyinfo_facultyconnections', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('facultyinfo', ['FacultyConnections'])


    def backwards(self, orm):
        # Deleting model 'FacultyInfo'
        db.delete_table('facultyinfo_facultyinfo')

        # Deleting model 'FacultyConnections'
        db.delete_table('facultyinfo_facultyconnections')
